...
/**
 * Card-shaped placeholder matching the flat surfaces used across the app —
 * a header line plus `lines` body rows of decreasing width.
 */
export function SkeletonCard({ lines = 3, className }: { lines?: number; className?: string }) {
  return (
    <div className={cn('rounded-2xl bg-card border border-border shadow-sm p-5', className)}>
